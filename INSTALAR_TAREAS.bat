...
powershell -ExecutionPolicy Bypass -Command ^
    ...
    "$settings = New-ScheduledTaskSettingsSet -ExecutionTimeLimit (New-TimeSpan -Hours 2) -RestartCount 2 -RestartInterval (New-TimeSpan -Minutes 15) -StartWhenAvailable -RunOnlyIfNetworkAvailable -WakeToRun;" ^
...
echo   - Valior Morning Pipeline  ->  06:00 AM diario (WakeToRun activo)
